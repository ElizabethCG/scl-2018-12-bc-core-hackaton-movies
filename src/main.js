...
const containerRoot = document.getElementById("root");
 ...
 <div class="row">
 <div class="col -xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mx-auto">   
 <div class="card">
 <div class="box">
 <div class="img">
 <a title="Movies" href="https://www.youtube.com/watch?v=ZQ-YX-5bAs0"><img src="${movies[position].Poster}" class="img" alt="Movies"></div></a>
